...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/muratgolswo/pipeline-template-catalog.git");
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>muratgolswo</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/muratgolswo/pipeline-template-catalog.git</repositoryUrl>
              <traits>
